      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center">
          ...
          <p className="text-sm text-brand-text/75 leading-relaxed max-w-xl mb-10">
            Здесь время замедляется. Мы создали А-фрейм «Репка» для тех, кому нужно на мгновение остановиться, сбросить лишний городской шум, побыть вдвоём или в кругу самых близких. Это не просто дом — это место, где пишется ваша личная история гармонии.
          </p>
